...
const Navbar = () => {
  ...
  return (
    <header
      data-aos="fade-down"
      className="py-4 top-0 2xl:px-32 xl:px-14 lg:px-7 absoulte z-40 w-full max-lg:px-7"
    >
      <nav className="flex justify-between items-center">
        ...
        <div className="flex flex-row flex-3 justify-between xl:gap-10 lg:gap-3 items-center max-lg:hidden">
          ...
          <button className="border-transparent text-[17px] rounded-md bg-[#ED017F] px-10 py-[10px] text-white tracking-widest">
            iSERVICE
          </button>
        </div>
        ...
        <div
          className={
            nav
              ? ' bg-white h-screen shadow-xl w-[60%] absolute top-0 left-0 px-10 py-14 ease-in-out duration-300 z-50'
              : 'hidden ease-in-out duration-150'
          }
        >
          <a href="/">
            <img src={Logo} alt="Logo" width={130} height={29} />
